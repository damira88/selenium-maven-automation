...
public class JobApplication {
	...
	public void setup() {
		...
		// implicit wait needs to be set up once in the beginning
		// and apllies for allselenium steps
	...
	public void navigateToHomePage() {
		driver.get("https://forms.zohopublic.com/murodil/" + "form/JobApplicationForm/formperma/kOqgtfkv1dMJ4Df6k4_"
				+ "mekBNfNLIconAHvfdIk3CJSQ");
		...
		// annualSalary=random.nextInt(90000)+60000;
		annualSalary = data.number().numberBetween(90000, 150000);
		...
		gitHub = "https://github.com/CybertekSchool/spring-2018";
		certifications = new ArrayList<>();
		certifications.add("Java OCA");
		certifications.add("AWS");
		certifications.add("ISQBT");
	...
	public void fullNameEmptyTest() {
		Assert.assertEquals(driver.getTitle(), "SDET Job Application");
		// driver.findElement(By.name("Name_First")).clear();
		// <input type="text" maxlength="255" elname="first"
		// name="Name_First" value="" invlovedinsalesiq="false">
		driver.findElement(By.xpath("//input[@name='Name_First']")).clear();
		// (//) double slash --> tag name-->squarebrackets[] --> inside square brackets
		// @
		// @ --> atrribute name _--> equal sign(=) --> value of atrribute in a single
		// quote
		...
		String nameError = driver.findElement(By.xpath("//*[@id='error-Name']")).getText();
	...
	public void setdateOfBirth(String bDay) {
		...
		driver.findElement(By.xpath("//input[@id='Date-date']")).sendKeys(bDay);
	}
	...
	public void verifySalaryCalculations(int annual) {
		...
		System.out.println(weekly + "\t" + hourly);
...
//		driver.findElement(By.xpath("//input[@id='Date-date']")).sendKeys("04-19-2008");
		...
		Select countryElem = new Select(driver.findElement(By.xpath("//select[@name='Address_Country']")));
		...
		driver.findElement(By.xpath("//input[@id='Checkbox_2']")).click();
